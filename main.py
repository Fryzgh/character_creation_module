...
def attack(char_name: str, char_class: str) -> str:
    """Функция для расчёта результата атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция для расчёта результата защиты."""
    if char_class == 'warrior':
        return (f'{char_name} '
                'блокировал '
...
def special(char_name: str, char_class: str) -> str:
    """Функция для расчёта результата использования специального умения."""
    if char_class == 'warrior':
        return (f'{char_name} '
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция для тренировки управления персонажем."""
    if char_class == 'warrior':
